...
class RealsenseCamera:
    ...
    def get_frame_stream(self):
        ...
        if not depth_frame or not color_frame:
            ...
            print("Error, could not get frame, make sure the Intel Realsense camera is correctly connected")
        ...
        return True, color_image, depth_image, color_intrin, depth_intrin, depth_image
